...
+ /home/xcamp/XB100/lab3/V-REP_scenes/Scene5_example/  is correct 
- /home/xcamp/XB100/lab3/V-REP_scenes/Scene5_example  is wrong 
```
...
This scene does not do motion planning. Instead, it displays the output of your motion planner. It expects you to provide the path to a folder (e.g. /home/xcamp/XB100/lab3/V-REP_scenes/Scene5_example/ ) with four files, named nodes.csv, edges.csv, path.csv, and obstacles.csv:
