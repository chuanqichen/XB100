...
+ Alternatively, stop the simulation and then press the Scenes button in the top toolbar to see 
+ which scenes are currently open and select one to be in the foreground. 
+ The scene selector toolbar button may also be used to switch between opened scenes. 
```
